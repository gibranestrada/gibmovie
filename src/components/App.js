...
const App = () => {
  ...
  useEffect(() => {
    Axios.post("../../.netlify/functions/apiRequest", {params: {first: `https://api.themoviedb.org/3/discover/movie?api_key=`, second: `&language=en-US&sort_by=popularity.desc&include_adult=false&page=1`}})
      .then(res => {
        dispatch({
